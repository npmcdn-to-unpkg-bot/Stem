var ArtistNotification = React.createClass({
  render: function() {
    return(
      <div className="artist-notification-wrapper col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <div className="artist-notification-header col-xs-12 col-sm-12 col-md-12 col-lg-12">
          <h3>Notifications</h3>
