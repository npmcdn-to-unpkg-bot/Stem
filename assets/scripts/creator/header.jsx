    ...
    return (
      <div className="creator-wrapper">
        ...
        <div className="creator-stats-wrapper">
          ...
          <div className="col-sm-offset-4 col-lg-offset-3 pad-t-md">
            <h2 className="col-xs-12 creator-banner-content">Laura Sanchez</h2>
          </div> 
          <div>
          ...
          <div className="col-sm-offset-4 col-lg-7 col-lg-offset-3">
            ...
            <button className="btn col-xs-12 col-sm-5 col-md-4 col-lg-4 collab-btn"><h3><span className="icon-mail"></span> Collaborate</h3></button>
          </div>
          </div>  
      </div>  
    );
