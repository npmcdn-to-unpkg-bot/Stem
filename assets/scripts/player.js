! function(e, a) {
    ...
    return function(e) {
        function a(l) {
            ...
            return e[l].call(i.exports, i, i.exports, a), i.loaded = !0, i.exports
        }
        var t = {};
        ...
        var r = [],
            n = function() {
                function e(a) {
                    ...
                    }, this.isMobile = /mobile/i.test(window.navigator.userAgent), this.isMobile && (a.autoplay = !1);
                    var i = {
                    ...
                    for (var r in i) i.hasOwnProperty(r) && !a.hasOwnProperty(r) && (a[r] = i[r]);
                    this.playIndex = "[object Array]" === Object.prototype.toString.call(a.music) ? 0 : -1, this.option = a, this.audios = [], this.loop = a.loop, this.secondToTime = function(e) {
                        var a = function(e) {
                                return e < 10 ? "0" + e : "" + e
                            },
                            t = parseInt(e / 60),
                        ...
                        for (var a = [], t = 0; t < e.length; t++) {
                            for (var l = e[t].split("\n"), i = [], r = l.length, n = 0; n < r; n++) {
                                var o = l[n].match(/\[(\d{2}):(\d{2})\.(\d{2,3})]/g),
                                    s = l[n].replace(/\[(\d{2}):(\d{2})\.(\d{2,3})]/g, "").replace(/^\s+|\s+$/g, "");
                                if (null != o)
                                    for (var p = o.length, u = 0; u < p; u++) {
                        ...
                        return a
                    }, this.updateBar = function(e, a, l) {
                        a = a > 0 ? a : 0, a = a < 1 ? a : 1, t[e + "Bar"].style[l] = 100 * a + "%"
                    }, this.updateLrc = function() {
                        var e = arguments.length <= 0 || void 0 === arguments[0] ? t.audio.currentTime : arguments[0];
                        if (t.lrcIndex > t.lrc.length - 1 || e < t.lrc[t.lrcIndex][0] || !t.lrc[t.lrcIndex + 1] || e >= t.lrc[t.lrcIndex + 1][0])
                            for (var a = 0; a < t.lrc.length; a++) e >= t.lrc[a][0] && (!t.lrc[a + 1] || e < t.lrc[a + 1][0]) && (t.lrcIndex = a, t.lrcContents.style.transform = "translateY(" + 20 * -t.lrcIndex + "px)", t.lrcContents.style.webkitTransform = "translateY(" + 20 * -t.lrcIndex + "px)", t.lrcContents.getElementsByClassName("aplayer-lrc-current")[0].classList.remove("aplayer-lrc-current"), t.lrcContents.getElementsByTagName("p")[a].classList.add("aplayer-lrc-current"))
                    ...
                    this.trigger = function(e) {
                        for (var a = 0; a < t.event[e].length; a++) t.event[e][a]()
                    }
                }
                return i(e, [{
                    key: "init",
                    value: function() {
                        function e(e) {
                            for (var a = e.offsetLeft, t = e.offsetParent, l = void 0; null !== t;) a += t.offsetLeft, t = t.offsetParent;
                            return l = document.body.scrollLeft + document.documentElement.scrollLeft, a - l
                        }

                        function a(e) {
                            for (var a = e.offsetTop, t = e.offsetParent, l = void 0; null !== t;) a += t.offsetTop, t = t.offsetParent;
                            return l = document.body.scrollTop + document.documentElement.scrollTop, a - l
                        }
                        var t = this;
                        ...
                        if (this.option.showlrc) {
                            ...
                            if (1 === this.option.showlrc)
                                if (this.multiple)
                                    for (l = 0; l < this.option.music.length; l++) i.push(this.option.music[l].lrc);
                                else i.push(this.option.music.lrc);
                        ...
                        this.element.innerHTML = n, this.element.offsetWidth < 300 && (this.element.getElementsByClassName("aplayer-icon-loop")[0].style.display = "none"), this.ptime = this.element.getElementsByClassName("aplayer-ptime")[0], this.element.getElementsByClassName("aplayer-info")[0].offsetWidth < 200 && this.element.getElementsByClassName("aplayer-time")[0].classList.add("aplayer-time-narrow"), this.bar = this.element.getElementsByClassName("aplayer-bar-wrap")[0], this.bar.style.marginRight = this.element.getElementsByClassName("aplayer-time")[0].offsetWidth + 5 + "px", this.option.narrow && this.element.classList.add("aplayer-narrow"), this.button = this.element.getElementsByClassName("aplayer-button")[0], this.button.addEventListener("click", function(e) {
                            t.button.classList.contains("aplayer-play") ? t.play() : t.button.classList.contains("aplayer-pause") && t.pause()
                        }), this.multiple && ! function() {
                            for (var e = t.element.getElementsByClassName("aplayer-list")[0].getElementsByTagName("li"), a = function(a) {
                                    e[a].addEventListener("click", function() {
                                        var l = parseInt(e[a].getElementsByClassName("aplayer-list-index")[0].innerHTML) - 1;
                                        l !== t.playIndex ? (t.setMusic(l), t.isMobile ? t.pause() : t.play()) : t.toggle()
                                    })
                                }, l = 0; l < t.option.music.length; l++) a(l)
                        }(), this.playedBar = this.element.getElementsByClassName("aplayer-played")[0], this.loadedBar = this.element.getElementsByClassName("aplayer-loaded")[0], this.thumb = this.element.getElementsByClassName("aplayer-thumb")[0];
                        var o = void 0;
                        this.bar.addEventListener("click", function(a) {
                            var l = a || window.event;
                            o = t.bar.clientWidth;
                            var i = (l.clientX - e(t.bar)) / o;
                            t.updateBar("played", i, "width"), t.element.getElementsByClassName("aplayer-ptime")[0].innerHTML = t.secondToTime(i * t.audio.duration), t.audio.currentTime = parseFloat(t.playedBar.style.width) / 100 * t.audio.duration
                        }), this.thumb.addEventListener("mouseover", function() {
                            t.thumb.style.background = t.option.theme
                        }), this.thumb.addEventListener("mouseout", function() {
                            t.thumb.style.background = "#fff"
                        });
                        var s = function(a) {
                                var l = a || window.event,
                                    i = (l.clientX - e(t.bar)) / o;
                                i = i > 0 ? i : 0, i = i < 1 ? i : 1, t.updateBar("played", i, "width"), t.option.showlrc && t.updateLrc(parseFloat(t.playedBar.style.width) / 100 * t.audio.duration), t.element.getElementsByClassName("aplayer-ptime")[0].innerHTML = t.secondToTime(i * t.audio.duration)
                            },
                            p = function y() {
                                document.removeEventListener("mouseup", y), document.removeEventListener("mousemove", s), t.audio.currentTime = parseFloat(t.playedBar.style.width) / 100 * t.audio.duration, t.playedTime = setInterval(function() {
                                    t.updateBar("played", t.audio.currentTime / t.audio.duration, "width"), t.option.showlrc && t.updateLrc(), t.element.getElementsByClassName("aplayer-ptime")[0].innerHTML = t.secondToTime(t.audio.currentTime), t.trigger("playing")
                                }, 100)
                            };
                        this.thumb.addEventListener("mousedown", function() {
                            o = t.bar.clientWidth, clearInterval(t.playedTime), document.addEventListener("mousemove", s), document.addEventListener("mouseup", p)
                        ...
                        this.element.getElementsByClassName("aplayer-volume-bar-wrap")[0].addEventListener("click", function(e) {
                            var l = e || window.event,
                                i = (c - l.clientY + a(u)) / c;
                            i = i > 0 ? i : 0, i = i < 1 ? i : 1, t.volume(i)
                        }), this.volumeicon.addEventListener("click", function() {
                            t.audio.muted ? (t.audio.muted = !1, t.volumeicon.className = 1 === t.audio.volume ? "aplayer-icon aplayer-icon-volume-up" : "aplayer-icon aplayer-icon-volume-down", 1 === t.audio.volume ? (t.volumeicon.className = "aplayer-icon aplayer-icon-volume-up", t.volumeicon.innerHTML = t.getSVG("volume-up")) : (t.volumeicon.className = "aplayer-icon aplayer-icon-volume-down", t.volumeicon.innerHTML = t.getSVG("volume-down")), t.updateBar("volume", t.audio.volume, "height")) : (t.audio.muted = !0, t.volumeicon.className = "aplayer-icon aplayer-icon-volume-off", t.volumeicon.innerHTML = t.getSVG("volume-off"), t.updateBar("volume", 0, "height"))
                        });
                        var d = this.element.getElementsByClassName("aplayer-icon-loop")[0];
                        d.addEventListener("click", function() {
                            t.loop ? (d.classList.add("aplayer-noloop"), t.loop = !1, t.audio.loop = !t.multiple && t.loop) : (d.classList.remove("aplayer-noloop"), t.loop = !0, t.audio.loop = !t.multiple && t.loop)
                        }), this.multiple && ! function() {
                            var e = t.element.getElementsByClassName("aplayer-list")[0];
                            e.style.height = e.offsetHeight + "px", t.element.getElementsByClassName("aplayer-icon-menu")[0].addEventListener("click", function() {
                                e.classList.contains("aplayer-list-hide") ? e.classList.remove("aplayer-list-hide") : e.classList.add("aplayer-list-hide")
                            })
                        }(), this.setMusic(0), r.push(this)
                    }
                }, {
                    key: "setMusic",
                    value: function(e) {
                        ...
                        if (this.music = this.multiple ? this.option.music[t] : this.option.music, this.music.pic && (this.element.getElementsByClassName("aplayer-pic")[0].style.backgroundImage = "url('" + this.music.pic + "')"), this.element.getElementsByClassName("aplayer-title")[0].innerHTML = this.music.title, this.element.getElementsByClassName("aplayer-author")[0].innerHTML = " - " + this.music.author, this.multiple && (this.element.getElementsByClassName("aplayer-list-light")[0] && this.element.getElementsByClassName("aplayer-list-light")[0].classList.remove("aplayer-list-light"), this.element.getElementsByClassName("aplayer-list")[0].getElementsByTagName("li")[t].classList.add("aplayer-list-light")), this.audio && (this.pause(), this.audio.currentTime = 0), this.multiple && !this.audios[t] || this.playIndex === -1 ? (this.audio = document.createElement("audio"), this.audio.src = this.music.url, this.option.preload ? this.audio.preload = this.option.preload : this.audio.preload = this.isMobile ? "none" : "metadata", this.audio.addEventListener("durationchange", function() {
                                ...
                                a.element.getElementsByClassName("aplayer-author")[0].innerHTML = " - Error happens ╥﹏╥", a.trigger("pause")
                            }), this.audio.addEventListener("canplay", function() {
                                a.trigger("canplay")
                            }), this.ended = !1, this.multiple ? this.audio.addEventListener("ended", function() {
                                return a.isMobile ? (a.ended = !0, void a.pause()) : void(0 !== a.audio.currentTime && (a.playIndex < a.option.music.length - 1 ? a.setMusic(++a.playIndex) : a.loop ? a.setMusic(0) : a.loop || (a.ended = !0, a.pause(), a.trigger("ended"))))
                            }) : this.audio.addEventListener("ended", function() {
                                a.loop || (a.ended = !0, a.pause(), a.trigger("ended"))
                            ...
                            this.lrc = this.multiple ? this.lrcs[t] : this.lrcs[0];
                            var l = "";
                            this.lrcContents = this.element.getElementsByClassName("aplayer-lrc-contents")[0];
                            for (var i = 0; i < this.lrc.length; i++) l += "<p>" + this.lrc[i][1] + "</p>";
                            this.lrcContents.innerHTML = l, this.lrcIndex || (this.lrcIndex = 0), this.lrcContents.getElementsByTagName("p")[0].classList.add("aplayer-lrc-current"), this.lrcContents.style.transform = "translateY(0px)", this.lrcContents.style.webkitTransform = "translateY(0px)"
                        }
                    ...
                    value: function(e) {
                        var a = this;
                        if ("[object Number]" === Object.prototype.toString.call(e) && (this.audio.currentTime = e), this.audio.paused) {
                            if (this.button.classList.remove("aplayer-play"), this.button.classList.add("aplayer-pause"), this.button.innerHTML = "", setTimeout(function() {
                                ...
                                for (var t = 0; t < r.length; t++) this != r[t] && r[t].pause();
        ...
        e.exports = function() {
            ...
            return e.toString = function() {
                ...
                for (var l = {}, i = 0; i < this.length; i++) {
                    var r = this[i][0];
                    "number" == typeof r && (l[r] = !0)
                }
                for (i = 0; i < a.length; i++) {
                    var n = a[i];
                    "number" == typeof n[0] && l[n[0]] || (t && !n[2] ? n[2] = t : t && (n[2] = "(" + n[2] + ") and (" + t + ")"), e.push(n))
                }
            }, e
        }
    }, function(e, a) {
        ...
        function l(e, a) {
            for (var t = 0; t < e.length; t++) {
                ...
                if (i) {
                    i.refs++;
                    for (var r = 0; r < i.parts.length; r++) i.parts[r](l.parts[r]);
                    for (; r < l.parts.length; r++) i.parts.push(p(l.parts[r], a))
                } else {
                    for (var n = [], r = 0; r < l.parts.length; r++) n.push(p(l.parts[r], a));
                    y[l.id] = {
                        id: l.id,
                        refs: 1,
                        parts: n
        ...
        function i(e) {
            for (var a = [], t = {}, l = 0; l < e.length; l++) {
                ...
                t[r] ? t[r].parts.push(p) : a.push(t[r] = {
                    id: r,
                    parts: [p]
                })
            }
        ...
        function r(e, a) {
            var t = f(),
                l = b[b.length - 1];
            if ("top" === e.insertAt) l ? l.nextSibling ? t.insertBefore(a, l.nextSibling) : t.appendChild(a) : t.insertBefore(a, t.firstChild), b.push(a);
            else {
        ...
        function o(e) {
            ...
            return a.type = "text/css", r(e, a), a
        }

        function s(e) {
            var a = document.createElement("link");
            return a.rel = "stylesheet", r(e, a), a
        }
        ...
        function p(e, a) {
            ...
            if (a.singleton) {
                var r = g++;
                t = v || (v = o(a)), l = u.bind(null, t, r, !1), i = u.bind(null, t, r, !0)
            } else e.sourceMap && "function" == typeof URL && "function" == typeof URL.createObjectURL && "function" == typeof URL.revokeObjectURL && "function" == typeof Blob && "function" == typeof btoa ? (t = s(a), l = d.bind(null, t), i = function() {
                n(t), t.href && URL.revokeObjectURL(t.href)
            }) : (t = o(a), l = c.bind(null, t), i = function() {
                n(t)
            });
            return l(e),
                function(a) {
        ...
        function u(e, a, t, l) {
            var i = t ? "" : l.css;
            if (e.styleSheet) e.styleSheet.cssText = x(a, i);
            else {
                var r = document.createTextNode(i),
                    n = e.childNodes;
                n[a] && e.removeChild(n[a]), n.length ? e.insertBefore(r, n[a]) : e.appendChild(r)
            }
        }
        ...
        function c(e, a) {
            var t = a.css,
                l = a.media;
            if (l && e.setAttribute("media", l), e.styleSheet) e.styleSheet.cssText = t;
            else {
        ...
        var y = {},
            h = function(e) {
                var a;
                return function() {
                    return "undefined" == typeof a && (a = e.apply(this, arguments)), a
                }
            },
            m = h(function() {
        ...
        e.exports = function(e, a) {
            a = a || {}, "undefined" == typeof a.singleton && (a.singleton = m()), "undefined" == typeof a.insertAt && (a.insertAt = "bottom");
            var t = i(e);
            return l(t, a),
                function(e) {
