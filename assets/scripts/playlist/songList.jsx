    ...
    return(
      <div className="playlist-table-wrapper col-xs-12 col-md-12 col-lg-12">
          <table className="col-xs-12 col-md-12 col-lg-12">
            <thead>
              <th className="col-xs-12 col-sm-2 col-md-2 col-lg-2 pad-b-md"><h4>Track/Artist</h4></th>
              <th className="col-xs-12 col-sm-2 col-md-2 col-lg-2 pad-b-md"><h4>Album</h4></th>
              <th className="col-xs-12 col-sm-2 col-md-2 col-lg-2 pad-b-md"><h4>Time</h4></th>
              <th className="col-xs-12 col-sm-2 col-md-2 col-lg-2 pad-b-md"><h4>Downloads</h4></th>
              <th className="col-xs-12 col-sm-2 col-md-2 col-lg-2 pad-b-md"><h4>Popular</h4></th>
              <th className="col-xs-12 col-sm-2 col-md-2 col-lg-2 pad-b-md"><h4>Options</h4></th>
            </thead>
            <tbody>
              <tr>
