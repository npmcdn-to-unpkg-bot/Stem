        ...
        <ul className="col-xs-12">
          <li className="col-xs-12">
            <div className="col-xs-7">
              <h4 className="playlist-mobile-view-detail">Cool Kids</h4>
              <p className="playlist-mobile-view-detail">Echosmith <span className="glyphicon glyphicon-minus"></span> Taking Dreams</p>
