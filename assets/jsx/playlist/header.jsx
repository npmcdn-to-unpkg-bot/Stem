      ...
      <div className="playlist-header-wrapper-fluid">
        <div className="playlist-header-banner col-xs-12 col-sm-12 col-md-12 col-lg-12">
          <ul>
            ...
            <li className="col-sm-7 col-md-7 col-lg-7">
              <h3 className="pad-t-lg pad-b-lg white">Check out the top rock tracks coming to you from some of todays most up and coming rockstars.</h3>
            </li>
            <li className="col-xs-12 col-sm-12 col-md-12 col-lg-12">
